...
var m = Math.round(p);
      ...
      elem.src = 'https://pixabay.com/static/uploads/photo/2015/10/01/21/39/background-image-967820_960_720.jpg';
      elem.width = '50';
      elem.height = '50';
      elem.id = 'oddImg';
      ...
      document.getElementById("rightSide").appendChild(elem);
          ...
          function imgTwo(){
            ...
            elem2.src = 'https://pixabay.com/static/uploads/photo/2015/10/01/21/39/background-image-967820_960_720.jpg'
            elem2.width = '50';
            elem2.height = '50';
            elem2.id = 'newImg';
